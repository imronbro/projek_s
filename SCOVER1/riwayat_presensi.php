  ...
  <style>
    ...
    @media (max-width: 480px) {
      ...
      .navbar .nav-links {
        ...
        /* Atur link navbar menjadi kolom */
        gap: 10px;
        /* Tambahkan jarak antar link */
      }
      ...
      .navbar .nav-links {
        display: none;
        /* Sembunyikan link navbar secara default */
        flex-direction: column;
        position: absolute;
        top: 60px;
        right: 0;
      ...
      .navbar .nav-links.active {
        display: flex;
        /* Tampilkan link navbar saat menu aktif */
      }
    }
  </style>
