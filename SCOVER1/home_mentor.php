...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO presensi_pengajar (pengajar_id, full_name, tanggal, sesi, status, komentar, waktu_presensi) VALUES (?, ?, ?, ?, ?, ?, NOW())";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("isssss", $pengajar_id, $full_name, $tanggal, $sesi, $status, $komentar);
...
<nav class="navbar">
    ...
    <div class="content">
        ...
        <div class="riwayat-presensi">
            <a href="riwayat_presensi_mentor.php" class="btn">Lihat Riwayat Presensi</a>
        </div>
    </div>
